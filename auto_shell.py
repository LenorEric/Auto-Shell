...
- If the task (including all user's appending goals in supplement) is complete (if really not sure, prefer asking the user), set cmd_type="done", operation=null, and provide done_summary.
